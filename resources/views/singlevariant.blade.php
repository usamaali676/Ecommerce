            ...
            <div class="row">
                    ...
                    <div class="product-slider-container" id="final">
                        ...
                        <div id="prod_img">
                            <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                @if(count($variant->variantimage) > 0)
                                @foreach ($variant->variantimage as $img)
                ...
                <div class="col-lg-7 col-md-6 product-single-details">
                    ...
                    <div class="price-box">
                        ...
                        <span class="new-price" id="prod-price">£{{ $variant->price }}</span>
                        @else
                    ...
                    <div class="d-flex">
                        @foreach ($color_variant as $color)
                            <a href="{{ route('variant', ['slug'=> $product->slug , 'id'=>$color->id]) }}" class="variants" id="{{ $color->id }}">
                ...
                <div class="d-flex">
                    @foreach ($storage_variant as $storage)
                        <a href="{{ route('variant', ['slug'=> $product->slug , 'id'=> $storage->id]) }}" class="variants" id="{{ $storage->id }}">
                            <div class="storage">
                                <p>{{ $storage->name }}</p>
                            </div>
                        </a>
